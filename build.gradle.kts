...
sonarqube {
    properties {
        ...
        property("sonar.projectKey", "library::spring-kotlin-validation")
        property("sonar.projectName", "spring-kotlin-validation")
    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                ...
                scm {
                    url.set("https://github.com/mbogner/library-spring-kotlin-validation")
                    connection.set("git@github.com:mbogner/library-spring-kotlin-validation.git")
                    developerConnection.set("git@github.com:mbogner/library-spring-kotlin-validation.git")
                }
                developers {
                    developer {
                        id.set("mbo")
